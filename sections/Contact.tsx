...
export const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const mailtoLink = `mailto:amitk.vishwa1633@gmail.com?subject=Portfolio Inquiry&body=Hi Amit,%0D%0A%0D%0AI wanted to reach out regarding...`;

      const openMail = window.confirm(
        "Something went wrong while sending your message. Would you like to email me directly instead?"
      );
  ...
  return (
    <Section id="contact">
      <SectionTitle title="Get In Touch" subtitle="06 // CONTACT" />

      <div className="grid lg:grid-cols-2 gap-16">
        <div>
          <p className="text-xl text-neutral-700 dark:text-neutral-300 mb-8">
            I’m always open to discussing backend engineering roles, interesting product ideas, freelance opportunities, or systems-focused collaborations. If you're building something meaningful, feel free to reach out.
          </p>
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-sky-500 text-black font-bold py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-sky-400 transition-all hover:shadow-[0_0_20px_rgba(56,189,248,0.3)] group disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:bg-sky-500 disabled:hover:shadow-none" disabled={sending}
          >
