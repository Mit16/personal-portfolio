    ...
    <Section id="contact">
      ...
      <div className="grid lg:grid-cols-2 gap-16">
        <div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4 group">
              <div className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-sky-500 group-hover:bg-sky-500 group-hover:text-black transition-all">
                <Mail size={20} />
              </div>
              <div>
                <p className="text-xs text-neutral-500 uppercase tracking-widest">Email</p>
                <p className="text-white">amitk.vishwa1633@gmail.com</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 group">
              ...
              <div>
                ...
                <p className="text-white">Sector 62, Noida, U.P.</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 group">
              ...
              <div>
                ...
                <p className="text-white">+91 9082526810</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 flex gap-4">
            <motion.a 
                ...
                target="_blank"
                className="p-4 bg-white/5 border border-white/10 rounded-2xl hover:text-sky-500"
            >
              <Github size={24} />
            </motion.a>
            <motion.a 
        ...
        <motion.form 
          ...
          className="bg-white/[0.02] border border-white/5 p-8 rounded-3xl backdrop-blur-md"
        >
          <div className="mb-6">
            ...
            <input 
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl p-4 text-white focus:outline-none focus:border-sky-500/50 transition-colors"
          ...
          <div className="mb-6">
            ...
            <textarea 
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl p-4 text-white focus:outline-none focus:border-sky-500/50 transition-colors resize-none"
