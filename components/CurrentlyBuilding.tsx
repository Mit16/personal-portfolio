    ...
    return (
        <AnimatePresence>
            {visible && (
                ...
                >
                    <div className="relative flex items-start gap-3 px-4 py-3 bg-[#030303]/90 border border-white/10 rounded-2xl backdrop-blur-md shadow-xl">
                        {/* Live pulse dot */}
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-sm font-semibold text-white font-futuristic truncate">
